...
// Source: github.com/sangketkit01/simple-bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) TransferTx(ctx context.Context, arg db.TransferParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
